...
\begin{document}
	...
	\end{lemma}
	\begin{proof}
		Quotients of algebras under twosided ideals are again algebras, hence so is $A/J$. Further, the underlying normed vector space of $A/J$ agrees with the quotient $A/J$ of underlying normed vector spaces, hence is the quotient of a Banach space by a closed subspace and as such again a Banach space.
	\end{proof}
	\begin{example}
	...
	\begin{definition}
		...
		\begin{align*}
			\sp(a)\coloneqq \{\lambda\in \C\mid (\lambda-a)\not\in A^{\times}\},
		\end{align*}
